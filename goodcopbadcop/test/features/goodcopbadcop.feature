Feature: showing off behave
  ...
  Scenario: check item TRUTH_SERUM
     Given we start a game with user 1 having TRUTH_SERUM
  ...
  Scenario: check item FLASHBANG
     Given we start a game with user 6 having FLASHBANG
  ...
  Scenario: check item BLACKMAIL
     Given we start a game with user non-leader having BLACKMAIL
